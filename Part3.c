...
int calculate_value(treenode *root);
				...
				case TN_EXPR:
					switch (root->hdr.tok) {
					  ...
					  case PLUS:
						  ...
						  if(is_constant(root->lnode) == 1 && is_constant(root->rnode) == 1)
                          {
                            return 1;
                          }
					  ...
					  case DIV:
                          ...
                          else if(is_constant(root->lnode) == 1 && calculate_value(root->lnode) == 0)
                          {
                            return 1;
                          }
					  ...
					  case STAR:
                          ...
                          else if(is_constant(root->rnode) == 1 && calculate_value(root->rnode) == 0)
                          {
                            return 1;
                          }
...
int calculate_value(treenode *root)
{
    ...
    switch (root->hdr.which){
		...
		case IF_T:
			...
			case TN_COND_EXPR:
				/* (cond)?(exp):(exp); */
				if(is_constant(ifn->cond) == 1 && calculate_value(ifn->cond) == 1)
                {
                    return calculate_value(ifn->then_n);
                }

                else if(is_constant(ifn->cond) == 1 && calculate_value(ifn->cond) == 0)
                {
                    return calculate_value(ifn->else_n);
                }
				...
				case TN_EXPR:
					switch (root->hdr.tok) {
					  ...
					  case GRTR:
                          ...
                          if(calculate_value(root->lnode) > calculate_value(root->rnode))
                          {
                            return 1;
                          }
    ...
    switch (root->hdr.which){
		...
		case IF_T:
			...
			case TN_COND_EXPR:
				...
				if(is_constant(ifn->cond) == 1 && calculate_value(ifn->cond) != 0)
                {
                    code_recur(ifn->then_n);
                }
			...
			switch (root->hdr.type) {
				...
				case TN_JUMP:
					if (root->hdr.tok == RETURN) {
						...
						else if(constant_swtich_value == 0)
                        {
                          printf("ujp label_%d\n",last_label_count);
						}
					}
				...
				case TN_SWITCH:
                    ...
                    if(is_constant(root->lnode) == 1)
                    {
                        switch_value = calculate_value(root->lnode);

                        constant_swtich_value = 1;

                        code_recur(root->rnode);

                        constant_swtich_value = 0;
                    }
				...
				case TN_ASSIGN:
					if(root->hdr.tok == EQ){
                      ...
                      break;
                        ...
                        if(is_constant(root->rnode) == 1 && calculate_value(root->rnode) == 1)
                        {
                            /** do nothing **/
                        }
					...
					switch (root->hdr.tok) {
					  ...
					  case DIV:
					  	  ...
					  	  if(is_constant(root) == 1)
                          {
					  	  ...
					  	  else if(is_constant(root->rnode) == 1 && calculate_value(root->rnode) == 1)
                          {
                             code_recur(root->lnode);
					  ...
					  case STAR:
					  	  ...
					  	  if(is_constant(root) == 1)
                          {
					  	  ...
					  	  else if(is_constant(root->lnode) == 1 && calculate_value(root->lnode) == 1)
                          {
                            code_recur(root->rnode);
				...
				case TN_LABEL:
				    ...
				    if(constant_swtich_value == 1)
                    {
                       leafnode* case_value_leaf = (leafnode*)root->lnode->rnode;

                       int case_value = case_value_leaf->data.ival;
